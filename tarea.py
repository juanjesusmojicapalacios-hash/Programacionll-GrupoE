...
def mostrarGenero():
    tk.messagebox.showinfo("Genero",f"ERl genero seleccionado es={genero.get()}")
...
#spinnbox de texto para genero
genero=tk.Spinbox(ventanaPrincipal,values=("Masculino","Femenino","Otro"))
genero.grid(row=2,column=1,padx=10,pady=10)
botonGenero=tk.Button(ventanaPrincipal,text="Obtener genero", command=mostrarGenero)
